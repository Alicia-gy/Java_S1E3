...
public class App {
	...
	public static void main(String[] args) {
		...
		String readPath = "G:\\Mi unidad\\Eclipse_Workspace\\S1E3\\src\\n1e3\\countries.txt";
	...
	public static int start (HashMap<String, String> countries) {
		...
		for(int i = 0; i < 10; i++) {
			...
			System.out.println("Cual es la capital de " + key + " ?");
	...
	public static void newFile(String name, int score) {
		...
		try {
			FileWriter file = new FileWriter("G:\\Mi unidad\\Eclipse_Workspace\\S1E3\\src\\n1e3\\resultado.txt");
			PrintWriter pw = new PrintWriter(file);
			pw.println("Usuario: " + name + " - Puntuacion: " + score);
			pw.close();
		} catch (IOException e) {
			e.printStackTrace();
		}
